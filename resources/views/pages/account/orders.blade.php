                        ...
                        <div class="tab-content" id="orderTabsContent">
                            <div class="tab-pane fade show active" id="all-orders" role="tabpanel">
                                ...
                                <div class="orders-empty">
                                    ...
                                    <a href="{{ route('products.index') }}" class="btn btn-primary" style="background: linear-gradient(135deg, #ff6f91, #ff9671); border: none; color: #fff;">Mua sắm ngay</a>
                                </div>
                                @else
                                ...
                                <div class="order-card mb-3 border rounded p-3">
                                    ...
                                    <div class="order-items">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            <img src="{{ $item->product?->thumb ?? '/img/default-product.png' }}" alt="" class="me-2 rounded" style="width: 50px; height: 50px; object-fit: cover;">
                                            <div class="flex-grow-1">
                                                <div class="fw-medium">{{ $item->product?->title ?? 'Sản phẩm' }}</div>
                                                <small class="text-muted">x{{ $item->quantity }}</small>
                                            </div>
                                            <div class="text-primary fw-bold">{{ number_format($item->price, 0, ',', '.') }}đ</div>
                                        </div>
                                        @endforeach
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-3 pt-3 border-top">
                                        ...
                                        <div>
                                            <a href="/account/orders/{{ $order->order_id }}" class="btn btn-outline-primary btn-sm">Xem chi tiết</a>
                                            @if($order->status === 0)
                                            <form action="/account/orders/{{ $order->order_id }}/cancel" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-outline-danger btn-sm ms-2" onclick="return confirm('Bạn có chắc muốn hủy đơn hàng này?')">Hủy đơn</button>
                                            </form>
                                            @endif
                                        </div>
                                    </div>

...
@section('content')
    <div class="grid">
        ...
        @if($searchProductsResponse->count)
            ...
            @if($searchProductsResponse->hasMore)
                <div class="text-center my-4">
                    <form method="GET" action="{{ route('products.index') }}">
                        ...
                        <input type="hidden" name="offset"
                               value="{{ $searchProductsResponse->offset + $searchProductsResponse->limit }}">
                        <input type="hidden" name="limit" value="{{ $searchProductsResponse->limit }}">
